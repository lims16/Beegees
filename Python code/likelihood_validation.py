...
for c in range(len(features)):
    ...
    vlup = pd.merge(vdf, pv, on=features[c], how='left')
    # print(vlup)
    # print(pv)

    # store probabilities
    for r in range(vdf.shape[0]):
